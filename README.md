...
The build runs 7,026 story assertions across 1,000 seeds before packaging. The standalone harness passes 108 checks covering the integrated opening, physical deliveries, helper gates, evidence, candle encounter, power repair, manifest, ending, save/load and restart. A further 319 graphics checks cover animations, placements and all three display modes. It uses a separate save file.
