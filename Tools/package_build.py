...
metadata={'title':'NO CAUSE FOR ALARM','version':'1.1.0','platform':'Windows x64','unity':'6000.4.7f1','file':archive.name,'bytes':len(data),'sha256':hashlib.sha256(data).hexdigest()}
